...
class Loader:
    def __init__(self, model_obj, output_path):
        self.model_obj = model_obj
        self.output_path = output_path
        self.files = {}
        self.id_counters = {}
        self.name_to_id = {"utilities": {}, "suppliers": {}}
    ...
    def setup_csv_files(self):
        ...
        for table in tables:
            file_path = os.path.join(self.output_path, f"{table}.csv")
        ...
        for utility in self.model_obj.utilities:
            ...
            for supplier in utility.suppliers:
                if supplier.name in self.name_to_id["suppliers"]:
                    ...
                    self.write_to_csv(
                        "suppliers", [supplier_id, supplier.name, utility_id]
                    )
                ...
                for plan in supplier.plans:
                    ...
                    for monthly_charge in plan.monthly_charges:
                        ...
                        self.write_to_csv(
                            ...
                            [
                                monthly_charge_id,
                                monthly_charge.min_value,
                                monthly_charge.max_value,
                                plan_id,
                            ],
                        )
                    ...
                    for usage_credit in plan.usage_credits:
                        ...
                        self.write_to_csv(
                            ...
                            [
                                usage_credit_id,
                                usage_credit.min_value,
                                usage_credit.max_value,
                                plan_id,
                            ],
                        )
                    ...
                    if plan.early_term_fee and plan.early_term_fee.min is not None:
                        ...
                        early_term_fee_data = [
                            early_term_fee_id,
                            plan.early_term_fee.min,
                            plan.early_term_fee.max,
                            plan.early_term_fee.early_term_fee_type,
                            plan.early_term_fee.term,
                            plan_id,
                        ]

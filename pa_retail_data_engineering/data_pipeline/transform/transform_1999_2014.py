"""
Transforms raw JSON records from the 1999 - 2014 data releases into the
...
class Transform1999To2014(BaseTransform):
    """handles JSON published between 1999 and 2014"""
                    ...
                    if isinstance(default_rates, list):
                        for rate_info in default_rates:
                            rate_data = {
                                ...
                                "rate_type": rate_type_mapping.get(
                                    rate_type_key, rate_type_key
                                ),  # Map to human-readable rate type
                            ...
                            if isinstance(amount, (int, float)):  # If it's a number
                                ...
                                amount, dict
                            ):  # If it's a nested structure (like time slots)
                ...
                for supplier_name, supplier_info in suppliers.items():
                    ...
                    if "plans" in supplier_info:
                        ...
                        for plan in plans:
                            ...
                            start_date_str, term_end_date_str, plan_end_date_str = (
                                None,
                                None,
                                None,
                            )
